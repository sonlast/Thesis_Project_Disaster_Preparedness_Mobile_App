...
import { Alert, Image, Text, View, StyleSheet, Pressable, TextInput, TouchableOpacity, } from "react-native";
              ...
              autoCapitalize="none"
				...
				<View style={styles.horizontalContainer}>
						<View style={styles.ageContainer}>
								<DropDownPicker
										placeholder="Age"
										placeholderStyle= {{ color: "#000000", fontFamily: "Anybody_700Bold", fontSize: 12, }}
										open={open}
										value={value}
										items={items}
										setOpen={setOpen}
										...
										setItems={setItems}
										showTickIcon={false}
										listItemLabelStyle ={{ fontFamily: "Anybody_700Bold", fontSize: 11, }}
				...
				<View style={{ marginTop: 10, }}>
					<Text style={styles.xtratxt}>Already have an account?{' '}
						<Text style={{ color: 'rgb(255, 0, 0)', }} onPress={pressLogin}>Log in here.</Text>
					</Text>
				</View>
			</View>
		</View>
